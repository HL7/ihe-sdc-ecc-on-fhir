...
Description: "A Observation Profile meant to capture string fill-in values from an IHE SDC Form. Any answer that has a string datatype in IHE SDC should be represented using this profile which requires the Observation.valueString"
* identifier 1..* MS 
* identifier ^definition = "The identifier should match the SDC Question instance-GUID"
* identifier ^binding.description = "The identifier should match the SDC answer instance-GUID"
